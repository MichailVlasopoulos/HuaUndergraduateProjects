...
public class DatacenterBrokerSimulationTest
{
    int VMS = 6;
    int VM_PES = 2;
    ...
    class DeviceMock
    {
        ...
        Double[] generateDistributionDataset(ContinuousDistribution distribution, int length)
        {
